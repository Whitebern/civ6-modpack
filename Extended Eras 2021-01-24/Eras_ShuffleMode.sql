-- This file is only active if the Tech and Civic Shuffle Mode is activated
...
-- Increase Technology random costs
UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*1.2) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_ANCIENT');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*1.5) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_CLASSICAL');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*1.9) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_MEDIEVAL');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*2.1) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_RENAISSANCE');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*2.3) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_INDUSTRIAL');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*2.4) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_MODERN');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*2.8) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_ATOMIC');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*3.2) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_INFORMATION');

UPDATE TechnologyRandomCosts SET Cost = ROUND(Cost*3.4) WHERE TechnologyType IN
(SELECT TechnologyType FROM Technologies WHERE EraType = 'ERA_FUTURE');
...
-- Increase Civic random costs
UPDATE CivicRandomCosts SET Cost = ROUND(Cost*1.4) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_ANCIENT')
AND Cost = 70; -- separating these out to avoid a unique constraint error

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*1.4) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_ANCIENT')
AND Cost = 50; -- separating these out to avoid a unique constraint error
...
UPDATE CivicRandomCosts SET Cost = ROUND(Cost*2.3) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_MEDIEVAL');

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*2.5) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_RENAISSANCE');

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*2.9) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_INDUSTRIAL');

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*3.1) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_MODERN');

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*3.3) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_ATOMIC');

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*3.5) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_INFORMATION');

UPDATE CivicRandomCosts SET Cost = ROUND(Cost*3.8) WHERE CivicType IN
(SELECT CivicType FROM Civics WHERE EraType = 'ERA_FUTURE');
