/*
	Civilizations Expanded: Localisation (New Frontier Pass)
	By p0kiehl
*/
...
--=============================================================================================================
		...
		('LOC_TRAIT_CIVILIZATION_BABYLON_NAME',
		'Star Cartography'),
		('LOC_TRAIT_CIVILIZATION_BABYLON_DESCRIPTION',
		'Begin the game with three three random [ICON_TechBoosted] Eurekas unlocked. +25% [ICON_Production] Production towards Campus districts and their buildings. Campus districts receive a standard [ICON_Science] Science adjacency bonus from other districts. +2 [ICON_Science] Science, +2 [ICON_Gold] Gold, +2 [ICON_Food] Food, and +2 [ICON_Production] Production from [ICON_TradeRoute] Trade Routes to City-States.'),
		-- Leader Unique Ability
		('LOC_TRAIT_LEADER_HAMMURABI_NAME',
		'Code of Hammurabi'),
		('LOC_TRAIT_LEADER_HAMMURABI_XP1_DESCRIPTION',
		'Begin the game with the Code of Laws civic unlocked. Training a melee unit in the [ICON_Capital] Capital grants a duplicate of that unit for free. Constructing a specialty district for the first time immediately grants the lowest [ICON_Production] Production cost building available for that district. Constructing any other district for the first time grants +2 [ICON_Envoy] Envoys.'),
		-- Unique Building
		('LOC_BUILDING_PALGUM_DESCRIPTION',
		'A building unique to Babylon that replaces the Water Mill. +2 [ICON_PRODUCTION] Production, +1 [ICON_Amenities] Amenity, and +1 [ICON_Housing] Housing. +1 [ICON_Food] Food and +1 [ICON_Gold] Gold to all tiles in this city adjacent to a source of Freshwater. Can only be built in cities founded on a River.'),
		-- Unique Unit
...
--=============================================================================================================
		...
		'+100% [ICON_GreatProphet] Great Prophet points. Defeating enemy units spreads Byzantium''s [ICON_Religion] Religion to nearby cities. +1 [ICON_Culture] Culture and +1 [ICON_Faith] Faith for each city following Byzantium''s [ICON_Religion] Religion. Units receive +3 [ICON_Strength] Combat Strength or +3 [ICON_Religion] Religious Strength for each Holy City following Byzantium''s [ICON_Religion] Religion.'),
		-- Leader Unique Ability
		('LOC_TRAIT_LEADER_BASIL_DESCRIPTION',
		'Holy Sites provide [ICON_Gold] Gold equal to their [ICON_Faith] Faith adjacency bonus. Military units heal at the end of every turn when within 3 tiles of a Holy Site. Heavy and light cavalry units do full damage when attacking cities following the same [ICON_Religion] Religion as Byzantium. Gain access to the Tagma unique unit after unlocking the Divine Right civic.'),
		...
		('LOC_P0K_BYZANTIUM_ABILITY_PORPHYROGENNETOS_NAME', -- NOTE: Ability is actually functionless and just added here for flavor. The effect is granted via modifier.
		'Boulgaroktόnos'),
		('LOC_P0K_BYZANTIUM_ABILITY_PORPHYROGENNETOS_DESCRIPTION',
		'Heals at the end of every turn when within 9 tiles of a Holy Site, even after moving or attacking (Boulgaroktόnos).'),
		-- Leader Unique Unit
		('LOC_UNIT_BYZANTINE_TAGMA_DESCRIPTION',
		'Byzantine unique Medieval era unit when Basil II is the leader. Replaces the Knight. Land units within 1 tile of the Tagma receive +4 [ICON_Strength] Combat Strength or +4 [ICON_RELIGION] Religious Strength.'),
		-- Unique District
		('LOC_DISTRICT_HIPPODROME_EXPANSION2_DESCRIPTION',
		'A district unique to Byzantium. Replaces the Entertainment Complex. Grants +3 [ICON_Amenities] Amenities and +1 [ICON_GreatGeneral] Great General point. Does not contribute to the city''s district limit based on [ICON_Citizen] Population. Upon constructing the Hippodrome and each of its buildings, receive a free heavy cavalry unit in that city. This free unit has no Strategic resource maintenance.'),
...
--=============================================================================================================
		...
		'[ICON_TradeRoute] Trade Routes gain +1 [ICON_Faith] Faith for passing through [ICON_TradingPost] Trading Posts in Ethiopian cities and +1 [ICON_Gold] Gold for passing through [ICON_TradingPost] Trading Posts in foreign cities. Resources provide +1 [ICON_Faith] Faith and additional yields based on their type: +1 [ICON_Food] Food from Bonus resources, +1 [ICON_Production] Production from Strategic resources, and +1 [ICON_Gold] Gold from Luxury resources. May purchase Government Plaza, Diplomatic Quarter, and Theater Square buildings with [ICON_Faith] Faith.'),
		-- Leader Unique Ability
		('LOC_TRAIT_LEADER_MENELIK_DESCRIPTION',
		'[ICON_Faith] Faith and [ICON_Gold] Gold purchases are 15% cheaper. Cities founded on Hills receive [ICON_SCIENCE] Science and [ICON_CULTURE] Culture equal to 15% of their [ICON_FAITH] Faith output. Military units receive +4 [ICON_STRENGTH] Combat Strength when fighting on Hills.'),
		-- Unique Improvement 
...
--=============================================================================================================
		...
		'All units receive +1 [ICON_Movement] Movement in Gallic territory. Training military units grants a burst of [ICON_Culture] Culture equal to 15% of the [ICON_Production] Production cost. Melee, anti-cavalry, and ranged units receive +2 [ICON_Strength] Combat Strength for each adjacent military unit.'),
...
--=============================================================================================================
		...
		'+20% [ICON_Production] Production towards districts and buildings when in a [ICON_Glory_Golden_Age] Golden Age. When in a [ICON_Glory_Dark_Age] Dark Age or [ICON_Glory_Normal_Age] Normal Age, [ICON_Citizen] Citizens exert Loyalty pressure as if in a [ICON_Glory_Golden_Age] Golden Age. +1 [ICON_Science] Science, +1 [ICON_Culture] Culture, +1 [ICON_Faith] Faith, +1 [ICON_Food] Food, +1 [ICON_Production] Production, and +1 [ICON_Gold] Gold from the Government Plaza and each of its buildings. +1 [ICON_Culture] Culture and +1 [ICON_Gold] Gold from each [ICON_Envoy] Envoy sent to a City-State.'),
		-- Leader Unique Ability
		('LOC_TRAIT_LEADER_CAMPANA_ADMIRABLE_NAME',
		'Patria Grande'),
		('LOC_TRAIT_LEADER_CAMPANA_ADMIRABLE_DESCRIPTION_XP1',
		'All units receive +1 [ICON_Movement] Movement on Gran Colombia''s home continent. Activating a unit [ICON_Promotion] Promotion does not end that unit''s turn. Receive two free [ICON_Envoy] Envoys upon unlocking a Diplomatic policy card. Entering a new Era grants a free Libertador, a unique type of [ICON_GreatPerson] Great Person. Gain access to the Liberation War casus belli after unlocking the Political Philosophy civic.'),
		('LOC_ABILITY_EJERCITO_PATRIOTA_EXTRA_MOVEMENT_DESCRIPTION',
		'+1 [ICON_Movement] Movement when on Gran Colombia''s home continent (Ejército Patriota).'),
		-- Leader Unique Unit
...
--=============================================================================================================
		...
		'Receive one extra Economic policy slot in any [ICON_Government] Government. +25% [ICON_Production] Production towards Commercial Hubs and their buildings. Commercial Hubs receive a standard [ICON_Gold] Gold adjacency bonus from other districts. Establishing a [ICON_TradingPost] Trading Post with another civilization for the first time grants a random [ICON_TechBoosted] Eureka and a random [ICON_CivicBoosted] Inspiration. [ICON_TradeRoute] Trade Routes are immune to being plundered over land tiles.'), 
		('LOC_P0K_ABILITY_SILK_ROAD_CARAVANS_NAME',
		'Silk Road Caravans'),
		('LOC_P0K_ABILITY_SILK_ROAD_CARAVANS_DESCRIPTION',
		'This unit''s [ICON_TradeRoute] Trade Route cannot be plundered while on a land tile.'),
--=============================================================================================================
-- MAYA
--=============================================================================================================
		-- Civilization Unique Ability
